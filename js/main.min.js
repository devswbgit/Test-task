...
!function(o){o(document).ready(function(){o(".form-open-icon").click(function(){o(".form-dropdown").fadeToggle(),o(this).toggleClass("active-click")}),o(".menu-bar").click(function(){o(this).toggleClass("active"),o(".main-manu-search .main-menu-wrap").slideToggle("slow",function(){})}),o(".home .main-arrow-down .arrow-down").click(function(){o([document.documentElement,document.body]).animate({scrollTop:o("#main-content").offset().top},2e3)}),o(".owl-carousel").owlCarousel({margin:0,nav:!0,loop:!1,responsive:{0:{items:1},600:{items:1},1e3:{items:1}}})})}(jQuery);